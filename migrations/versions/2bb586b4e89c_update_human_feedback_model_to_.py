"""Update human feedback model to accommodate conversation id

Revision ID: 2bb586b4e89c
Revises: 0e40a1de89c3
Create Date: 2023-11-23 16:19:01.328048
...
revision: str = '2bb586b4e89c'
down_revision: Union[str, None] = '0e40a1de89c3'
...
def upgrade() -> None:
    ...
    op.add_column('humanfeedback', sa.Column('conversation_id', sa.UUID(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('humanfeedback', 'conversation_id')
