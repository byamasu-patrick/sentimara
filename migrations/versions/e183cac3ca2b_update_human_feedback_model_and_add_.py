"""Update human feedback model and add temperature settings

Revision ID: e183cac3ca2b
Revises: 795666e0a7f4
Create Date: 2023-11-23 15:09:36.083538
...
revision: str = 'e183cac3ca2b'
down_revision: Union[str, None] = '795666e0a7f4'
...
def upgrade() -> None:
    ...
    op.add_column('message', sa.Column('temperature', sa.Float(), nullable=True))
