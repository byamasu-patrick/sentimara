...
from libs.models.db import (
    ...
    # NetPromoterScore,
    # OtherClassifiedDiseases,
    # OtherUnclassifiedDiseases,
    Demographic,
    ProxyRespondent,
    # RespondentLogin
)
...
class DBSeeder:
    ...
    def insert_into_sqlite_response(self, pg_responses):
        # Iterate through PostgreSQL results and insert into SQLite
    ...
    #             CompletedSurveyRespondents).filter_by(id=pg_completion.id).first()
    ...
    def fetch_survey_data(self):
        ...
        return (pg_respondents, pg_responses, pg_treatment_patterns, pg_demographics, pg_colleagues, pg_proxy_respondents)
    ...
    def seed(self):
        ...
        (pg_respondents, pg_responses, pg_treatment_patterns, pg_demographics,
         pg_colleagues, pg_proxy_respondents) = self.fetch_survey_data()
