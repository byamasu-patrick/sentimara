...
class DBEventHandler:
    def __init__(self, db_uri: str, sqlite_session, condition_to_function_map: dict[str, str]):
    ...
    def listen_to_changes(self, conn: Connection):
        ...
        while True:
            ...
            while conn.notifies:
                ...
                if action == 'INSERT':
                    print(
                        f"New record inserted in {table_name} with ID {record_id}")
                    ...
                    print(
                        f"Record in {table_name} with ID {record_id} was updated")
