...
class QueryEngineInfo:
    def __init__(self, engine: SQLTableRetrieverQueryEngine, query_engine_description: str, top_query_engine_description: str):
        self.engine = engine
...
class TableInfo:
    def __init__(self, name: str, query_engine_description: str, top_query_engine_description: str):
        self.name = name
        self.query_engine_description = query_engine_description
        self.top_query_engine_description = top_query_engine_description
