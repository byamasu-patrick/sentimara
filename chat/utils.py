...
table_groups: List[TableInfo] = [
    TableInfo(
        ...
        top_query_engine_description="""
          An advanced engine tailored to the 'respondents' table, designed to analyze participant profiles, encompassing professional backgrounds, contact information, and geographic data. This engine provides a comprehensive snapshot of participant diversity and professional networks.
        """,
    ),
    TableInfo(
        name="completed_survey",
        query_engine_description="""
          This engine delves into the 'completed_survey' table, focusing on dissecting survey completion data to glean insights into respondent engagement and survey effectiveness. It analyzes elements such as survey year, completion status, and timestamps of creation, updating, and publication, along with respondent demographics that include names, organizations, and locations. This detailed analysis aids in identifying trends and patterns in survey participation, offering valuable insights into the temporal dynamics of respondent engagement and the geographic spread of participation.
        """,
        top_query_engine_description="""
          An engine specifically designed for the 'completed_survey' table, adept at analyzing survey completion trends and respondent demographics. It evaluates respondent engagement and survey design effectiveness by examining completion rates, temporal patterns, and the geographical distribution of participants.
        """,
    ),
    TableInfo(
        name="responses",
        query_engine_description="""
          This engine expertly navigates the 'responses' table, focusing on a detailed analysis of respondent feedback in surveys. It processes a broad spectrum of data, including patient numbers reported, specific defects, and categorizations (including sub-categories), along with OMIM entry IDs and gene names related to these defects. Additionally, it analyzes respondent details such as names and organizational affiliations, as well as geographic information. This thorough analysis enables the engine to discern trends, patterns, and emerging themes in responses, especially in the context of patient reports and genetic information. It is instrumental for organizations seeking to understand complex survey outcomes and extract actionable insights from detailed respondent feedback.
        """,
        top_query_engine_description="""
          A specialized tool for in-depth analysis of the 'responses' table, adept at interpreting a wide range of survey data. It skillfully handles information from patient reports and genetic data to respondent demographics. This engine is essential for extracting comprehensive insights from survey results, and for understanding intricate patterns in respondent feedback.
        """,
    ),
    TableInfo(
        name="treatment_patterns",
        query_engine_description="""
          This analytical engine navigates the 'treatment_patterns' table to offer in-depth insights into patient treatment patterns for Primary Immunodeficiency (PI). It analyzes data on the total number of patients followed, those diagnosed with PI defects, those diagnosed through Jeffrey's Insights Genetic Sequencing Program, and the diverse range of treatment approaches. These include immunoglobulin therapies (administered in clinics or at home), gene therapy, enzyme replacement, and various types of transplantations, categorized by donor type and stem cell source. The engine is adept at conducting row counts, comparing values across columns, and tracking changes over time using the 'survey_year' field. It also correlates treatment data with geographical information, such as 'locality', 'region', and 'country_name', enabling multifaceted queries. These range from extracting basic statistics to performing complex comparative analyses of treatment methods and outcomes.
    """,
        top_query_engine_description="""
          The top-level query engine excels in analyzing the 'treatment_patterns' table, adept at addressing queries related to patient numbers under observation, those identified with PI defects, and the treatments administered. It analyzes data on immunoglobulin therapies across various settings, gene therapy, and stem cell transplants, distinguished by donor type and stem cell source. This engine also compares these figures for comprehensive analysis, such as evaluating the proportion of patients diagnosed through the Jeffrey Insights Program against the total number followed. It is instrumental in evaluating treatment effectiveness and reach across demographics and time, thereby enhancing insights into treatment impacts and patient outcomes.
    """,
    ),
    TableInfo(
        name="demographics",
        query_engine_description="""
          This engine specializes in analyzing the 'demographics' table, providing a detailed examination of the demographic distribution of patients covered in the survey. It processes essential data such as age breakdowns, gender counts (male and female), and detailed geographical information, including locality, region, and country. Additionally, it interprets temporal data like survey year, as well as organization and respondent details, offering a nuanced view of demographic trends and patterns within the survey population. The engine's proficiency in dissecting and understanding these demographic facets renders it invaluable for comprehending the diversity and demographic characteristics of the survey population.
        """,
        top_query_engine_description="""
